...
export class MyApp {
  ...
  constructor(public platform: Platform, private network: Network, public statusBar: StatusBar, public splashScreen: SplashScreen, public storage: Storage, public restProvider: RestProvider, public alertCtrl: AlertController) {
    this.initializeApp();
  ...
  initializeApp() {
      this.platform.ready().then(() => {
         ...
         var status = false;
         if(this.network.type !== 'none' || navigator.onLine){
           status = true;
